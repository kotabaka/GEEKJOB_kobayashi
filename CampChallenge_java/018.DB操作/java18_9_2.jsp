<%-- 
    Document   : java18_9_2
    Created on : 2018/04/06, 10:54:18
    Author     : guest1Day
--%>
    ...
    <body>
        <h1>
         ...
         try {
             ...
             ResultSet rs = null;
             sql = db_con.prepareStatement("INSERT INTO profiles(profilesID,name,tel,age,birthday)VALUES(?,?,?,?,?)");
             sql.setString(1,getid);
             sql.setString(2,getname);
             sql.setString(3,gettel);
             sql.setInt(4,formatage);
             sql.setDate(5,formatbday);
